---
title: "Figure2Supp_TregPercent.7dafterBMT_inVivoDistribution"
...
knitr::write_bib(.packages(), "Figure2Supp_TregPercent.7dafterBMT_inVivoDistribution.packages.bib")
```
...
p <- p + labs(title="re-isolated Treg (GvHD)",x="organ", y = "% of WBC")
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure2Supp_TregPercent.7dafterBMT_inVivoDistribution_SessionInfo.txt")
```