...
knitr::write_bib(.packages(), "Figure2b_BMTGvHDscore.packages.bib")
```
...
p
#pdf("./figures/Figure2b_BMTGvHDscore.pdf", height=4.5, width=7.5)
#p
#dev.off()
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure2b_BMTGvHDscore_SessionInfo.txt")
```
