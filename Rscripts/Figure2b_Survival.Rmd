...
knitr::write_bib(.packages(), "Figure2b_Survival.packages.bib")
```
...
```{r}
pdf("./figures/Figure2b_Survival.pdf", height=4.5, width=6)
p
dev.off()
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure2b_Survival_SessionInfo.txt")
```
