...
knitr::write_bib(.packages(), "Figure2c_Survival.packages.bib")
```
...
surv.data$group <- factor(surv.data$group,levels = c("BMonly","noTreg","alloTreg","polyTreg"))
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure2c_Survival_SessionInfo.txt")
```
