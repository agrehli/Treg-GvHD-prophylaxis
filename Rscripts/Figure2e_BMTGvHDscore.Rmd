...
knitr::write_bib(.packages(), "Figure2e_BMTGvHDscore.packages.bib")
```
...
p <- p + stat_summary(fun.data=mean_se, geom="errorbar", color="black", size=0.5, width = 4, position=position_dodge(.9))
...
```{r, fig.width=7.5, fig.height=4.5, warning=FALSE}
pdf("./figures/Figure2e_BMTGvHDscore.pdf", height=4.5, width=7.5)
p
dev.off()
```
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure2e_BMTGvHDscore_SessionInfo.txt")
```
