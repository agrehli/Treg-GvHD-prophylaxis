---
title: "FigureS1c_SuppressionAssay"
...
knitr::write_bib(.packages(), "FigureS1c_SuppressionAssay.packages.bib")
```
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/FigureS1c_SuppressionAssay_SessionInfo.txt")
```
