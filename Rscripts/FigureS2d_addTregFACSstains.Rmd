---
title: "FigureS2d_addTregFACSstains"
...
knitr::write_bib(.packages(), "FigureS2d_addTregFACSstains.packages.bib")
```
...
p <- p + stat_summary(fun.data=mean_se, fun.args = list(mult=1), geom="errorbar", color="black", linewidth=0.5, width = 0.6, position=position_dodge(.9))
...
p
pdf("./figures/FigureS2d_addStains_percentPos.pdf", height=3.5, width=12.5)
p
dev.off()
```
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/FigureS2d_addTregFACSstains_SessionInfo.txt")
```
