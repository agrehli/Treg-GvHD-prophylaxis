...
knitr::write_bib(.packages(), "Figure3&4_UMAP_Heatmaps_GSEA_Barplots_pro.prc.bas.don_packages.bib")
```
...
pcbd.ind<-pcbd.ind==F
print(paste(sum(pcbd.ind),"samples enter the analysis!"))
```
...
* Consequently, the group, only the organ, only the setting and the expansion mode for the Treg prior Tx plus Sell+/- for physiologically tissue-resident Treg are required as subsequently defined variables.
...
pcbd.cl.metascape.cl1 <- read_excel("./METASCAPE/cl1.metascape_result.xlsx", sheet=2)
...
## Cluster 2
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl2 <- read_excel("./METASCAPE/cl2.metascape_result.xlsx", sheet=2)
...
## Cluster 3
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl3 <- read_excel("./METASCAPE/cl3.metascape_result.xlsx", sheet=2)
...
## Cluster 5
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl5 <- read_excel("./METASCAPE/cl5.metascape_result.xlsx", sheet=2)
...
## Cluster 6
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl6 <- read_excel("./METASCAPE/cl6.metascape_result.xlsx", sheet=2)
...
## Cluster 7 
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl7 <- read_excel("./METASCAPE/cl7.metascape_result.xlsx", sheet=2)
...
## Cluster 8
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl8 <- read_excel("./METASCAPE/cl8.metascape_result.xlsx", sheet=2)
...
## Cluster 9
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl9 <- read_excel("./METASCAPE/cl9.metascape_result.xlsx", sheet=2)
...
## Cluster 10
```{r, fig.height=1.3, fig.width=2.2, out.width="20%"}
pcbd.cl.metascape.cl10 <- read_excel("./METASCAPE/cl10.metascape_result.xlsx", sheet=2)
...
* Herafter, expression profiles of genes associated with suppressive Treg functions are presented as barplots.

### Index for Suppression Signature
* Herafter, an index is generated based on the genes defined withing the "Suppression Signautre".
* This way, the dataframe for bar plots can be easily subsetted.
```{r}
...
* All generated barplots are arranged as plot grid, hereafter.
...
* The barplot arrangement is also exported into the figure directory.
...
writeLines(capture.output(sessionInfo(package = NULL)), "./Rscripts/Figure3&4_UMAP_Heatmaps_GSEA_Barplots_pro.prc.bas.don_SessionInfo.txt")
```
