...
```{r}
cvnc.pc.ind<-(grepl("prc",metad.m$appl)|grepl("pro",metad.m$appl))&(grepl("S", metad.m$org)|grepl("C", metad.m$org)|grepl("L", metad.m$org))
...
counts.cvnc.pc<-counts.m[,cvnc.pc.ind]
...
```{r}
metad.cvnc.pc<-metad.m[cvnc.pc.ind,]
...
geom_text_repel(data = subset(cvnc.pc.tr.qstat.scat.filt,
