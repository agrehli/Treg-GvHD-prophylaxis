...
* export PCR2-batch-corrected Log2RPKM values with internal IDs
* Note: The supplementary file of the manuscript contains the manuscript-relevant nomenclature

```{r}
# add annotation from DGEList object
bulkRNA.seq.Log2.RPKM.PCR2.batch.cor <- as.data.frame(pcbd.log.rpkm.cor) %>% 
  rownames_to_column(var = "longID") %>%
  inner_join(rownames_to_column(dgel.pcbd$genes, var ="longID"))
# export as .csv
...
df.test<-data.frame(appl.treat.pcbd,group.pcbd,org.pcbd)
df.test
```
...
avp.goi<-c("Penk","Nrn1","Nrgn","Ccdc184")
```
...
```{r}
write.table (as.data.frame(bar.df.mod.avp), file = "./ANALDIR/dataFigureS3e.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
```
...
* A column containing GeneIDs is appended, as well, followed by a consistency check.
```{r}
...
* exporting the clustered data table

```{r}
write.table (as.data.frame(pcbd.hm.df.jt.cus) %>% tibble::rownames_to_column("GeneID"), file = "./ANALDIR/dataFigure3e.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
# Metascape Results (Supplementary Figure 3 m)
* Enrichment results generated using Metascape/Enrichr are presented as barplots, hereafter.
* Be aware that clusters 1-3 in the manuscript equal clusters 1-3 herein, while clusters 4-9 in the manuscript equal clusters 5-10 herein, respectively.

**defining a theme function**
```{r}
theme_gobar <- function(){ 
...
## Cluster 1
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl1 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl1.metascape_result.xlsx", sheet=2)
...
pcbd.cl.metascape.cl1.bar <- ggplot(pcbd.cl.metascape.cl1.sig) + 
    ...
    theme_gobar()
pcbd.cl.metascape.cl1.bar
```

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl1 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl1_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl1$Term <- factor(pcbd.cl.hallmark.cl1$Term, level=pcbd.cl.hallmark.cl1$Term)
pcbd.cl.hallmark.cl1.sig <- subset(pcbd.cl.hallmark.cl1, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl1.bar <- ggplot(pcbd.cl.hallmark.cl1.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="forestgreen") +
    ggtitle(label = "Cluster 1") +
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl1.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl1 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl1_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl1$Term <- factor(pcbd.cl.bioplanet.cl1$Term, level=pcbd.cl.bioplanet.cl1$Term)
pcbd.cl.bioplanet.cl1.sig <- subset(pcbd.cl.bioplanet.cl1, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl1.bar <- ggplot(pcbd.cl.bioplanet.cl1.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="forestgreen") +
...
## Cluster 2
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl2 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl2.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl2 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl2_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl2$Term <- factor(pcbd.cl.hallmark.cl2$Term, level=pcbd.cl.hallmark.cl2$Term)
pcbd.cl.hallmark.cl2.sig <- subset(pcbd.cl.hallmark.cl2, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl2.bar <- ggplot(pcbd.cl.hallmark.cl2.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="darkorange1") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl2.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl2 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl2_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl2$Term <- factor(pcbd.cl.bioplanet.cl2$Term, level=pcbd.cl.bioplanet.cl2$Term)
pcbd.cl.bioplanet.cl2.sig <- subset(pcbd.cl.bioplanet.cl2, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl2.bar <- ggplot(pcbd.cl.bioplanet.cl2.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="darkorange1") +
...
## Cluster 3
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl3 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl3.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl3 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl3_MSigDB_hallmark_2020_table.txt")
pcbd.cl.hallmark.cl3$Term <- factor(pcbd.cl.hallmark.cl3$Term, level=pcbd.cl.hallmark.cl3$Term)
pcbd.cl.hallmark.cl3.sig <- subset(pcbd.cl.hallmark.cl3, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl3.bar <- ggplot(pcbd.cl.hallmark.cl3.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="darkmagenta") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl3.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl3 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl3_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl3$Term <- factor(pcbd.cl.bioplanet.cl3$Term, level=pcbd.cl.bioplanet.cl3$Term)
pcbd.cl.bioplanet.cl3.sig <- subset(pcbd.cl.bioplanet.cl3, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl3.bar <- ggplot(pcbd.cl.bioplanet.cl3.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="darkmagenta") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl3.bar
```

## Cluster 5
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl5 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl5.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl5 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl5_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl5$Term <- factor(pcbd.cl.hallmark.cl5$Term, level=pcbd.cl.hallmark.cl5$Term)
pcbd.cl.hallmark.cl5.sig <- subset(pcbd.cl.hallmark.cl5, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl5.bar <- ggplot(pcbd.cl.hallmark.cl5.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="cyan2") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl5.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl5 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl5_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl5$Term <- factor(pcbd.cl.bioplanet.cl5$Term, level=pcbd.cl.bioplanet.cl5$Term)
pcbd.cl.bioplanet.cl5.sig <- subset(pcbd.cl.bioplanet.cl5, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl5.bar <- ggplot(pcbd.cl.bioplanet.cl5.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="cyan2") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl5.bar
```

## Cluster 6

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl6 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl6.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl6 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl6_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl6$Term <- factor(pcbd.cl.hallmark.cl6$Term, level=pcbd.cl.hallmark.cl6$Term)
pcbd.cl.hallmark.cl6.sig <- subset(pcbd.cl.hallmark.cl6, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl6.bar <- ggplot(pcbd.cl.hallmark.cl6.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="yellow2") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl6.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl6 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl6_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl6$Term <- factor(pcbd.cl.bioplanet.cl6$Term, level=pcbd.cl.bioplanet.cl6$Term)
pcbd.cl.bioplanet.cl6.sig <- subset(pcbd.cl.bioplanet.cl6, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl6.bar <- ggplot(pcbd.cl.bioplanet.cl6.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="yellow2") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl6.bar
```

## Cluster 7 

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl7 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl7.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl7 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl7_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl7$Term <- factor(pcbd.cl.hallmark.cl7$Term, level=pcbd.cl.hallmark.cl7$Term)
pcbd.cl.hallmark.cl7.sig <- subset(pcbd.cl.hallmark.cl7, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl7.bar <- ggplot(pcbd.cl.hallmark.cl7.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="red") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl7.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl7 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl7_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl7$Term <- factor(pcbd.cl.bioplanet.cl7$Term, level=pcbd.cl.bioplanet.cl7$Term)
pcbd.cl.bioplanet.cl7.sig <- subset(pcbd.cl.bioplanet.cl7, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl7.bar <- ggplot(pcbd.cl.bioplanet.cl7.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="red") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl7.bar
```

## Cluster 8

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl8 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl8.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl8 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl8_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl8$Term <- factor(pcbd.cl.hallmark.cl8$Term, level=pcbd.cl.hallmark.cl8$Term)
pcbd.cl.hallmark.cl8.sig <- subset(pcbd.cl.hallmark.cl8, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl8.bar <- ggplot(pcbd.cl.hallmark.cl8.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="hotpink") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl8.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl8 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl8_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl8$Term <- factor(pcbd.cl.bioplanet.cl8$Term, level=pcbd.cl.bioplanet.cl8$Term)
pcbd.cl.bioplanet.cl8.sig <- subset(pcbd.cl.bioplanet.cl8, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl8.bar <- ggplot(pcbd.cl.bioplanet.cl8.sig) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="hotpink") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl8.bar
```

## Cluster 9

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl9 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl9.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl9 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl9_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl9$Term <- factor(pcbd.cl.hallmark.cl9$Term, level=pcbd.cl.hallmark.cl9$Term)
pcbd.cl.hallmark.cl9.sig <- subset(pcbd.cl.hallmark.cl9, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl9.bar <- ggplot(pcbd.cl.hallmark.cl9.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="blue") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl9.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl9 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl9_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl9$Term <- factor(pcbd.cl.bioplanet.cl9$Term, level=pcbd.cl.bioplanet.cl9$Term)
pcbd.cl.bioplanet.cl9.sig <- subset(pcbd.cl.bioplanet.cl9, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl9.bar <- ggplot(pcbd.cl.bioplanet.cl9.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="blue") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl9.bar
```

## Cluster 10

```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.metascape.cl10 <- read_excel("./METASCAPE/SupplementaryFigure3m_cl10.metascape_result.xlsx", sheet=2)
...
```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.hallmark.cl10 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl10_MSigDB_Hallmark_2020_table.txt")
pcbd.cl.hallmark.cl10$Term <- factor(pcbd.cl.hallmark.cl10$Term, level=pcbd.cl.hallmark.cl10$Term)
pcbd.cl.hallmark.cl10.sig <- subset(pcbd.cl.hallmark.cl10, Adjusted.P.value < 0.05)
pcbd.cl.hallmark.cl10.bar <- ggplot(pcbd.cl.hallmark.cl10.sig) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="lawngreen") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.hallmark.cl10.bar
```


```{r, fig.height=1, fig.width=6, out.width="20%"}
pcbd.cl.bioplanet.cl10 <- read.delim("./METASCAPE/SupplementaryFigure3m_cl10_BioPlanet_2019_table.txt")
pcbd.cl.bioplanet.cl10$Term <- factor(pcbd.cl.bioplanet.cl10$Term, level=pcbd.cl.bioplanet.cl10$Term)
pcbd.cl.bioplanet.cl10.sig <- subset(pcbd.cl.bioplanet.cl10, Adjusted.P.value < 0.05)
pcbd.cl.bioplanet.cl10.bar <- ggplot(pcbd.cl.bioplanet.cl10.sig[1:5,]) + 
    aes(x=Term, y=-log10(Adjusted.P.value) ) + coord_flip() + 
    scale_x_discrete(limits=rev) +
    scale_y_continuous(expand = c(0,0)) +
    geom_bar(stat="identity", fill="lawngreen") +
    ...
    ylab(bquote(italic(P)[adj.] *"("*-log[10]*")")) + xlab("") +
    theme_gobar()
pcbd.cl.bioplanet.cl10.bar
```

## Plot Grid
* All flipped bar plots are arranged in a plot grid, hereafter.
```{r fig.height=9, fig.width=18, out.width="50%"}
metascape.grid <- cowplot::plot_grid(pcbd.cl.metascape.cl1.bar,
                                       pcbd.cl.metascape.cl2.bar,
                                       pcbd.cl.metascape.cl3.bar,
                                       pcbd.cl.metascape.cl5.bar,
                                       pcbd.cl.metascape.cl6.bar,
                                       ...
                                       pcbd.cl.metascape.cl10.bar,
                                       ncol=1, align="v")
hallmark.grid <- cowplot::plot_grid(pcbd.cl.hallmark.cl1.bar,
                                       pcbd.cl.hallmark.cl2.bar,
                                       pcbd.cl.hallmark.cl3.bar,
                                       pcbd.cl.hallmark.cl5.bar,
                                       pcbd.cl.hallmark.cl6.bar,
                                       ...
                                       pcbd.cl.hallmark.cl10.bar,
                                       ncol=1, align="v") 
bioplanet.grid <- cowplot::plot_grid(pcbd.cl.bioplanet.cl1.bar,
                                       pcbd.cl.bioplanet.cl2.bar,
                                       pcbd.cl.bioplanet.cl3.bar,
                                       pcbd.cl.bioplanet.cl5.bar,
                                       pcbd.cl.bioplanet.cl6.bar,
                                       ...
                                       pcbd.cl.bioplanet.cl10.bar,
                                       ncol=1, align="v") 
cowplot::plot_grid(metascape.grid,
                   hallmark.grid,
                   bioplanet.grid,
                   labels = c("","",""),
                   rel_widths = c(1, 1, 1),
...
```{r}
cowplot::ggsave2("./FIGDIR/SupplementaryFigure3m_pcbd.graphia.clusters.metascape.enrichr.pdf",
  scale = 1,
  width = 18,
  height = 9,
  )
...
# Transcription Factors Zscore Heatmap of Graphia-Clusters (Figure 3 f)
...
```{r, fig.height=8.6, fig.width=6.8}
# index
...
#exportimg the data frame
write.table (as.data.frame(TF.sig.hm) %>% tibble::rownames_to_column("ShortID"), file = "./ANALDIR/dataFigure3g.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#color scale
...
```{r}
pdf(file = "./FIGDIR/Figure3f_pcbd.Zscore.heatmap.TFs.in.graphia.clusters.pdf",height = 8.6,width = 3.8)
heatmap.2(x = TF.sig.hm.matrix, 
          Rowv=NA, 
          Colv=NA,
          dendrogram = "none",
...
## Heatmap (Figure 4 d)
* Heatmap presenting hierarchically clustered and scaled expression data of genes associated with suppressiv Treg functions.
```{r, fig.height=3.6, fig.width=6.8}
# index generation
...
# export data frame
write.table (as.data.frame(supp.sig.hm.matrix) %>% tibble::rownames_to_column("ShortID"), file = "./ANALDIR/dataFigure4d.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
# heatmap colors
clustercol <- colorRampPalette(c("blue","white","red"))(29)
col_breaks = c(seq(-1.5,-0.5,length=10), seq(-0.49,0.49,length=10), seq(0.5,1.5,length=10)) 
# heatmap.2
...
write.table (as.data.frame(bar.df.mod.supp), file = "./ANALDIR/dataFigureS4d.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
# Additional barplots for pTreg signature genes (Supplementary Figure 3l)

* pTreg-typical genes described by van der Veeken et al. 2022.

```{r}
pTreg.sig <- c("Rorc","Maf","Ahr","Gpr15")
```

* extract data frame

```{r}
pTreg.idx<-which(bar.df.mod$gene_symbol %in% pTreg.sig)
bar.df.mod.pTreg<-bar.df.mod[pTreg.idx,]
# exporting the data frame
write.table (as.data.frame(bar.df.mod.pTreg), file = "./ANALDIR/dataFigureS3l.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
```
...
```{r,fig.height=2.0, fig.width=1.5}
bar.p.mod.Rorc <- ggplot(data = filter(bar.df.mod, gene_symbol ==
                                              pTreg.sig[1]), 
                       aes(x = group,
                           y = 2^(LOG.2.RPKM+2),
                           fill = group,
...
```{r,fig.height=2.0, fig.width=1.5}
bar.p.mod.Maf <- ggplot(data = filter(bar.df.mod, gene_symbol ==
                                              pTreg.sig[2]), 
                       aes(x = group,
                           y = 2^(LOG.2.RPKM-2),
                           fill = group,
...
```{r,fig.height=2.0, fig.width=1.5}
bar.p.mod.Ahr <- ggplot(data = filter(bar.df.mod, gene_symbol ==
                                              pTreg.sig[3]), 
                       aes(x = group,
                           y = 2^(LOG.2.RPKM-4),
                           fill = group,
...
```{r,fig.height=2.0, fig.width=1.5}
bar.p.mod.Gpr15 <- ggplot(data = filter(bar.df.mod, gene_symbol ==
                                              pTreg.sig[4]), 
                       aes(x = group,
                           y = 2^(LOG.2.RPKM-2),
                           fill = group,
...
```{r, fig.height=2, fig.width=6.0}
bar.p.pTreg.grid <- plot_grid(bar.p.mod.Rorc,
                              bar.p.mod.Maf,
                              bar.p.mod.Ahr,
                              bar.p.mod.Gpr15,
                              ncol=4, align="v")
...
* The pTreg marker gene bar plot arrangement is also exported into the figure directory.

```{r}
pdf(file="./FIGDIR/SupplementaryFigure3l_pcbd.pTreg.vanderVeeken.combined.barplot.RPKM.pdf", 
    height=2, width=6)
bar.p.pTreg.grid
dev.off()
```
