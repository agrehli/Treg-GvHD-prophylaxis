...
* All three barplots are exported into the figure directory, hereafter.
```{r}
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.colon_Hallmark_TNFA.pdf", height=3.2, width=6)
cpc.bc.TNFA.pryr
dev.off()
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.liver_Hallmark_TNFA.pdf", height=3.2, width=6)
lpc.bc.TNFA.pryr
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.spleen_Hallmark_TNFA.pdf", height=3.2, width=6)
spc.bc.TNFA.pryr
dev.off()
```
...
* All three barplots are exported into the figure directory, hereafter.
```{r}
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.colon_Hallmark_KeggREP.pdf", height=3.2, width=6)
cpc.bc.KREP.pryr
dev.off()
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.liver_Hallmark_KeggREP.pdf", height=3.2, width=6)
lpc.bc.KREP.pryr
pdf(file="./FIGDIR/SupplementaryFigure4a_Barcodeplot_pvc.spleen_Hallmark_KeggREP.pdf", height=3.2, width=6)
spc.bc.KREP.pryr
dev.off()
```
