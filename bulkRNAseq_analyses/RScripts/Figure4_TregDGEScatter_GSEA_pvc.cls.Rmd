...
spc.scat.spleen <- ggplot(spc.cp.qstat.scat.filt) + 
  ...
  geom_text_repel(data = subset(spc.cp.qstat.scat.filt, direction = "both",
                  ...
                  fontface="italic") +
 geom_text_repel(data = subset(spc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% replication.sig),aes(label=GeneSymbol),
                 force = 50, 
                 force_pull = 1, 
                 size=2, 
                 min.segment.length=0, 
                 ...
                 fontface="italic") +
 geom_text_repel(data = subset(spc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% ifn.res.spc.sig),aes(label=GeneSymbol),
                 force = 50, 
                 force_pull = 1, 
                 size=2, 
                 min.segment.length=0,
                 ...
                 fontface="italic") +
 geom_text_repel(data = subset(spc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% tnf.bind.r.sig),aes(label=GeneSymbol),
                 force = 50, 
                 force_pull = 1, 
                 ...
                 direction = "both", 
                 fontface="italic") +
  ggtitle(label = "DEGs pro. vs. ctrl.BMT", subtitle = "spl. re-iso. Treg, black: supp.sig, purple: repl. \ngreen: ifn.I.response, pink: tnf.bind.r.sig") +
...
lpc.scat.liver <- ggplot(lpc.cp.qstat.scat.filt) + 
  ...
  geom_text_repel(data = subset(lpc.cp.qstat.scat.filt, direction = "both",
                  ...
                  fontface="italic") +
  geom_text_repel(data = subset(lpc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% ifn.res.lpc.sig),aes(label=GeneSymbol),
                  force = 50, 
                  force_pull = 1, 
                  size=2, 
                  min.segment.length=0, 
                  ...
                  fontface="italic") +
 geom_text_repel(data = subset(lpc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% th17.diff.sig),aes(label=GeneSymbol),
                  force = 50, 
                 force_pull = 1, 
                 size=2, 
                 min.segment.length=0, 
                 ...
                 direction = "both", 
                 fontface="italic") +
  ggtitle(label = "DEGs pro. vs. ctrl. BMT", subtitle = "liver re-isolated Treg, black: supp.sig \ngreen: ifn.I.response, blue: th17.diff.sig") +
  ylab(bquote(log[2]~CPM ~"("*GvHD*")"))+
  xlab(bquote(log[2]~CPM ~"("*no~GvHD*")"))+
  theme(plot.title = element_text(size = 10, face = "bold"),
        plot.subtitle = element_text(size = 6, face = "bold"),
...
cpc.scat.colon <- ggplot(cpc.cp.qstat.scat.filt) + 
  ...
  geom_text_repel(data = subset(cpc.cp.qstat.scat.filt, direction = "both",
                  ...
                  fontface="italic") +
  geom_text_repel(data = subset(cpc.cp.qstat.scat.filt, direction = "both",
                                GeneSymbol %in% tcell.diff.sig),aes(label=GeneSymbol),
                  force = 50, 
                  force_pull = 1, 
                  size=2, 
                  min.segment.length=0,
