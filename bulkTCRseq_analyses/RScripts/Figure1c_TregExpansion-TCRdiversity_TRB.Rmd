...
p <- p + ggtitle("TRA Clonotype\nDiversity",subtitle = "downsampled (n=33K)") + ylim(0,25000)
p <- p + geom_dotplot(binaxis='y', stackdir='center', position=position_dodge(1), dotsize=2.0, colour="black", binwidth=500) 
