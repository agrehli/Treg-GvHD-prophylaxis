...
if (@ARGV < 5) {
	print STDERR "\nUsage: bulkTCRcreateJoinedCountTable.pl <output dir> <output file name>\n";
	print STDERR "Program joining reformated IA clonotype count data from several samples into one table\n";
	print STDERR "\trequired:\n";
	print STDERR "\t-mergeFiles <bulkTCR_IAcountTable files generated using the bulkTCRparseImmunArch.pl script> \n";
...
my $outfile3 = $outDir . "/bulkTCRcountTable." . $outfileName . ".norm" . $norm . "K.txt";
