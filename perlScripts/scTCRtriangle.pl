...
if (@ARGV < 2) {
	print STDERR "\nUsage: scTCRtriangle.pl <input table> <output directory> <analysis name>\n";
	print STDERR "Program filtering and combining the information of clonotype files from cell ranger output\n";
