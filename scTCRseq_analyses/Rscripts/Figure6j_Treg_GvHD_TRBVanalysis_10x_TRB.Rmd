---
title: "Figure6j_Treg_GvHD_TRBVanalysis_10x_TRB"
...
knitr::write_bib(.packages(), "Figure6j_Treg_GvHD_TRBVanalysis_10x_TRB.packages.bib")
```
...
generating the bar chart for Figure 6j
...
writeLines(capture.output(sessionInfo(package = NULL)), "Figure6j_Treg_GvHD_TRBVanalysis_10x_TRB_SessionInfo.txt")
```
