...
TRBV12-1
```{r}
stat.data.12.1 <- melted_gu %>% filter(Class!='d' & variable == 'TRBV12-1') 
res.aov.12.1 <- aov(value~Class, data=stat.data.12.1)
summary (res.aov.12.1)
TukeyHSD(res.aov.12.1)
```

TRBV12-2
```{r}
stat.data.12.2 <- melted_gu %>% filter(Class!='d' & variable == 'TRBV12-2') 
res.aov.12.2 <- aov(value~Class, data=stat.data.12.2)
summary (res.aov.12.2)
TukeyHSD(res.aov.12.2)
```

TRBV26
```{r}
stat.data.26 <- melted_gu %>% filter(Class!='d' & variable == 'TRBV26') 
res.aov.26 <- aov(value~Class, data=stat.data.26)
summary (res.aov.26)
TukeyHSD(res.aov.26)
```
